                                            ...
                                            <div class='modal-content-user'>
                                                ...
                                                <div class="add__inputs" style="width: 380px;">
                                                    <div class="add__box">
                                                        ...
                                                        <h3 class="view-h3">{{ $user->created_at }}</h3>
                                                    </div>

                                                    <div class="add__box">
                                                        <h3 class="add_h" style="text-align: left;">Updated at</h3>
                                                        <h3 class="view-h3">{{ $user->updated_at }}</h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div> 
